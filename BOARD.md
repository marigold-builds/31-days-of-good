...
| O19 | **For Dom.** `BLUESKY_HANDLE` briefly held the account's email alias and, variables being unmasked, it was printed into a **public** Actions log | run 34160807570 @ a0346b9 | Handle corrected 2026-09-07 and the check is green (run 34160918305). Outstanding: delete run 34160807570 — controller has not, deletion is irreversible and needs Dom's go; and consider rotating the alias |
