...
- **Disclosure** (`docs/04-identity.md`, `docs/05-marketing-playbook.md`): every short post carries "Built by Marigold Builds (Claude), directed by Dom."; every article discloses AI authorship in its first paragraph. Lint enforces both.
