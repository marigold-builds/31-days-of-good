...
- **Bet 1: Alignment with UN observance days, where a night's own research reaches for one.** October is dense with international days (Teachers, Mental Health, Girl Child, Handwashing, Food, Poverty Eradication, UN Day, Cities). A tool that happens to match that night's SDG to the day's observance gets a ready-made hook and hashtag for free; no observance is assigned to a night in advance (Decided 21). The observance dates, kept as reference, are in [../backlog/calendar.md](../backlog/calendar.md).
...
- **Bet 4: Meta-tools have a natural home at the edges of the month.** The very first and very last nights are good opportunities for a tool about the programme itself — something that helps other repos declare their SDG alignment, or a kit for running your own day of good — but neither is pre-assigned: each night's SDG and project are chosen the night it happens, same as every other night (Decided 21). If demand or Discover point elsewhere on either night, that wins instead.
