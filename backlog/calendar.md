# Calendar · October 2026 (proposed)

One SDG focus per day, aligned to UN observance days where one exists. Every SDG appears at least once; fourteen appear twice. Dates and floating observances verified against un.org and specialist sources in September 2026 (see [../docs/09-research-notes.md](../docs/09-research-notes.md)). Reorder freely until 13 September.

Legend: **Obs.** = observance hook · **Arch.** = suggested archetype (see [../docs/03-selection-criteria.md](../docs/03-selection-criteria.md)) · **Seed** = a candidate from [seed-ideas.md](seed-ideas.md), not a commitment.

| Day | Date | SDG | Obs. | Arch. | Seed |
|-----|------|-----|------|-------|------|
| 1 | Thu 1 Oct | 17 Partnerships | Launch day; Int'l Day of Older Persons noted | GitHub Action + badge | `sdg-badge`: declare a repo's SDG alignment with a badge and a validated `SDG.yml` |
| 2 | Fri 2 Oct | 16 Peace & Justice | Int'l Day of Non-Violence | Static tool | `foia-draft`: freedom-of-information request generator with per-country templates |
| 3 | Sat 3 Oct | 3 Health | Older Persons (1 Oct, carried) | PWA, offline | `med-times`: large-type, offline medication schedule that prints |
| 4 | Sun 4 Oct | 15 Life on Land | World Space Week begins; World Animal Day (non-UN) | Library | `inat-pull`: iNaturalist and GBIF observations to clean CSV/GeoJSON |
| 5 | Mon 5 Oct | 4 Education | World Teachers' Day; World Habitat Day | CLI | `md2quiz`: markdown to printable and interactive quizzes, offline |
| 6 | Tue 6 Oct | 11 Cities | World Habitat Day (carried) | Static map tool | `walkshed`: 15-minute walking isochrones from OpenStreetMap, no key |
| 7 | Wed 7 Oct | 12 Responsible Consumption | World Cotton Day | Static tool | `repair-or-replace`: cost and carbon calculator with open emission factors |
| 8 | Thu 8 Oct | 10 Reduced Inequalities | World Sight Day | GitHub Action | `a11y-gate`: accessibility check on every PR with plain-language reports |
...
- World Statistics Day (20 Oct) is only observed every five years and does not fall in 2026.
- World Habitat Day is the first Monday of October, so 5 October in 2026; it collides with World Teachers' Day and is carried to the 6th.
- Global Handwashing Day is WHO/UNICEF-backed rather than a UN General Assembly day; still a strong hook.
- The mid-month maintenance sprint sits on Sunday 18 October, after the dense 13–17 observance cluster, and pairs with a low-risk dataset archetype.
